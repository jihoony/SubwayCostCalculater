...
class DistanceBaseSubwayCostCalculateImplTest {
    ...
    void cal_SubwayCost_with_2050won(){
        ...
        DistanceBaseSubwayCostCalculateResult calculateSubwayCostResult = subwayCostCalculate.calculate(2_050L, startDate, endDate, new ArrayList<>(), null);
    ...
    void cal_SubwayCost_with_1200won(){
        ...
        DistanceBaseSubwayCostCalculateResult calculateSubwayCostResult = subwayCostCalculate.calculate(1_200L, startDate, endDate, new ArrayList<>(), null);
        System.out.println("calResult = " + calculateSubwayCostResult);
    ...
    void cal_SubwayCost_with_1500won(){
        ...
        DistanceBaseSubwayCostCalculateResult calculateSubwayCostResult = subwayCostCalculate.calculate(1_500L, startDate, endDate, new ArrayList<>(), null);
        System.out.println("calResult = " + calculateSubwayCostResult);
    ...
    void calSubwayCostWith1Holidays(){
        ...
        DistanceBaseSubwayCostCalculateResult calculateSubwayCostResult = subwayCostCalculate.calculate(2_050L, startDate, endDate, holidays, null);
        System.out.println("calResult = " + calculateSubwayCostResult);
    ...
    void calSubwayCost3MatchHolidaysWith3HolidaysAnd1AdditionalOffDays(){
        ...
        DistanceBaseSubwayCostCalculateResult calculateSubwayCostResult = subwayCostCalculate.calculate(2_050L, startDate, endDate, holidays, additionalOffDays);
        System.out.println("calResult = " + calculateSubwayCostResult);
